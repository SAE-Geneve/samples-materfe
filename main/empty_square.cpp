...
namespace gpr
{
    class EmptySquare final : public Scene
    {
    public:
        void Begin() override;
        void End() override;
    ...
    void EmptySquare::Begin()
    {
        //Load shaders
        const auto vertexContent = LoadFile("data/shaders/squares/empty_square.vert");
    ...
    void EmptySquare::Update(float dt)
    {
        //Draw program
