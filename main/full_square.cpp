...
namespace gpr
{
    class FullSquare final : public Scene
    {
    public:
        void Begin() override;
        void End() override;
    ...
    void FullSquare::Begin()
    {
        //Load shaders
        const auto vertexContent = LoadFile("data/shaders/squares/full_square.vert");
    ...
    void FullSquare::Update(float dt)
    {
        //Draw program
