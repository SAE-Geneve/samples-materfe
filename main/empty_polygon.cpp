...
namespace gpr
{
    class EmptyPolygon final : public Scene
    {
    public:
        void Begin() override;
        void End() override;
    ...
    void EmptyPolygon::Begin()
    {
        //Load shaders
        const auto vertexContent = LoadFile("data/shaders/polygon/empty_polygon.vert");
    ...
    void EmptyPolygon::Update(float dt)
    {
        //Draw program
